...
<%@ page import = "com.w.bean.AdminBean" %>
<%@ page import = "com.w.bean.HistoryBean" %>
<%@ page import = "com.w.dao.BookDao" %>
<%@ page import = "com.w.dao.AdminDao" %>
                    ...
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                           ...
                           if(bookdata==null){
                        	   ...
                        	   bookdata = (ArrayList<HistoryBean>)bookdao.get_HisoryListInfo(1, aid);
